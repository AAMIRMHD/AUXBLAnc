          ...
          <div className="lg:col-span-4 text-left">
            ...
            <div className="flex items-center space-x-4 mt-2">
              ...
              <a
                ...
                className="w-9 h-9 flex items-center justify-center rounded-lg bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 hover:scale-110 transition-transform duration-300 shadow-sm"
              >
                <svg
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="w-9 h-9 flex items-center justify-center rounded-lg bg-[#0077B5] hover:scale-110 transition-transform duration-300 shadow-sm"
              >
                <svg
                  className="w-4 h-4 text-white"
                  viewBox="0 0 24 24"
